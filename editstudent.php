                ...
                while ($row = mysqli_fetch_array($result)) {
                    ?>
                                    <article class="card mb-4">
                                        ...
                                        <input type="text" hidden value="<?php echo $row["student_id"]; ?>" name="id">
                                        <div class="card-body">
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control" required type="date" data-val="true" data-val-required="The Emergency Call field is required." id="EmergencyCall" name="dob" value="<?php echo $row["dob"]; ?>" />
                                                    <span class="input-group-addon" aria-hidden="true"><span class="glyphicon glyphicon-ok text-success"></span></span>
                                                </div>
                                                <span class="text-danger field-validation-valid" data-valmsg-for="EmergencyCall" data-valmsg-replace="true"></span>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control" required type="date" data-val="true" data-val-required="The Emergency Call field is required." id="EmergencyCall" name="doj" value="<?php echo $row["doj"]; ?>" />
                                                    <span class="input-group-addon" aria-hidden="true"><span class="glyphicon glyphicon-ok text-success"></span></span>
                                                </div>
                                                <span class="text-danger field-validation-valid" data-valmsg-for="EmergencyCall" data-valmsg-replace="true"></span>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control" required type="text" data-val="true" data-val-required="The Emergency Call field is required." id="EmergencyCall" name="fees" value="<?php echo $row["fee"]; ?>" />
                                                    <span class="input-group-addon" aria-hidden="true"><span class="glyphicon glyphicon-ok text-success"></span></span>
                                                </div>
                                                <span class="text-danger field-validation-valid" data-valmsg-for="EmergencyCall" data-valmsg-replace="true"></span>
                                            </div>
