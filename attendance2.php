    ...
    <div class="pcoded-wrapper">
        <div class="pcoded-content">
                                ...
                                <div id="collapseOne" class=" card-body collapse show" aria-labelledby="headingOne" data-parent="#accordionMain">
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            <div class="card">
                                                <div class="card-body">
                                                    <h4 class="card-title mb-4">Types Of Attendance</h4>
                                                    <div class="chart-container doughnut">
                                                        <canvas id="doughnutChart" height="34" width="50"></canvas>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            $behalf=$row['name']; 
                ?>
                                                        <?php 
                                                                    $sql = "select count(id) as a from attendance where behalf='$behalf'";
                                                                    $result = mysqli_query($con, $sql);
                                                                    $row = mysqli_fetch_array($result)
                                                                   ?>
                                                            <h3 class="mb-2"><?php echo $row["a"];?></h3>
                                                            <h5 class="text-muted f-w-300 mb-4">Total Attendance</h5>
...
<br>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>List of Attendance of Students</h5>
                                        <div class="card-header-right">
                                            <div class="btn-group card-option">
                                                <form action="attendanceform2.php">
                                    ...
                                    <div class="card-block">
                                        <div class="table-responsive">
                                            <table id="myTable" class="display table nowrap table-striped table-hover" style="width:100%">
                                                <thead>
                                                    <tr>
                                                    <th width="5%"></th>
                                                    <th width="5%"></th>
            ...
            $behalf=$row['name']; 
                ?>
                                                <?php
                // put your code here
                $sql = "select * from attendance where behalf='$behalf'";
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ?>
                                                <tbody>
                                                <td>
                                                                <a href="editattendance2.php?id=<?php echo $row['id'];?>"><i class="feather icon-edit"></i></a>
                                                            </td>
                                                            <td>
                                                                <a href="deleteattendance2.php?id=<?php echo $row['id'];?>"><i class="feather icon-trash"></i></a>
                                                            </td> 
                                                <td><?php echo $row["studentname"]; ?></td>
                                                <td><?php echo $row["subjectname"]; ?></td>
                                                <td><?php echo $row["behalf"]; ?></td>
                                                <td><?php echo $row["date"]; ?></td>
                                                <td><?php echo $row["class"]; ?>-th</td>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <p class="mb-3">
                                                Attendance module will give you tools to manage and submit your Student Attendance.  
                                                                                         </p>
                                            ...
                                            <ul class="list list-unstyled mb-3">
                                                ...
                                                <li><i class="feather icon-check-circle btn-outline-primary"></i> Setup the Attendance dates</li>
                                                <li><i class="feather icon-check-circle btn-outline-primary"></i> Edit of Attendance</li>
                                                <li><i class="feather icon-check-circle btn-outline-primary"></i> Delete of Attendance</li>
                                            </ul>
