                                ...
                                <div id="collapseOne" class=" card-body collapse show" aria-labelledby="headingOne" data-parent="#accordionMain">
                                    <div class="row">
                                        ...
                                        <div class="card">
                                                        ...
                                                        <?php 
                                                                    $sql = "select count(id) as a from attendance";
...
<br>
                                    ...
                                    <div class="card-header">
                                        ...
                                        <div class="card-header-right">
                                            <div class="btn-group card-option">
                                                <form action="attendanceform.php">
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ?>
                                                <tbody>
                                                <td>
                                                                <a href="editattendance.php?id=<?php echo $row['id'];?>"><i class="feather icon-edit"></i></a>
                                                            </td>
                                                            <td>
                                                                <a href="deleteattendance.php?id=<?php echo $row['id'];?>"><i class="feather icon-trash"></i></a>
                                                            </td> 
...
<script type="text/javascript">
      ...
      <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.metismenu li:nth-child(8)').addClass('active');
