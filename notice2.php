                                ...
                                <div id="collapseOne" class=" card-body collapse show" aria-labelledby="headingOne" data-parent="#accordionMain">
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            <div class="card">
                                                <div class="card-body">
                                                    <h4 class="card-title mb-4">Types Of Notice</h4>
                                        ...
                                        <div class="card">
                                                        ...
                                                        <?php 
                                                            ...
                                                            <h5 class="text-muted f-w-300 mb-4">Total Notices</h5>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>List of Notices</h5>
                                        <div class="card-header-right">
                                            <div class="btn-group card-option">
                                                <form action="noticeform2.php">
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ?>
                                                <tbody>
                                                            ...
                                                            <td>
                                                                <a href="deletenotice2.php?id=<?php echo $row['id'];?>"><i class="feather icon-trash"></i></a>
                                                            </td> 
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <p class="mb-3">
                                                Notice module will give you tools to manage the Subjects. </p>
                                            <h5 class="card-title mb-4">Notice Module features:</h5>
                                            <ul class="list list-unstyled mb-3">
                                                <li><i class="feather icon-check-circle btn-outline-primary"></i> Add Notice</li>
                                                <li><i class="feather icon-check-circle btn-outline-primary"></i> Delete Notice</li>
                                               </ul>
                                        </blockquote>
