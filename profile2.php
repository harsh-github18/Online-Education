                    ...
                    ?>
                                                <h4 class="font-weight-bold">Basic Info
                                                            ...
                                                            <div>
                                                                ...
                                                                <h5 class="font-weight-bold">Date of Joining</h5>
                                                                <p><?php echo $row["doj"]; ?>
                                                                    <hr>
                                                                </p>
                                                            </div>  <div>
                                                            ...
                                                            <div>
                                                                <h5 class="font-weight-bold">Class</h5>
                                                                <p><?php echo $row["class"]; ?>-th
                                                                    <hr>
                                                                </p>
                                                            </div>
                                                            <div>
                                                                <h5 class="font-weight-bold">Stream</h5>
                                                                <p><?php echo $row["stream"]; ?>
                                                                    <hr>
                                                                </p>
                                                            </div>
                <?php }?>
