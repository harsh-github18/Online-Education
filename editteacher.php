            ...
            <div class="pcoded-inner-content">
                ...
                <div class="page-header">
                    <div class="page-block">
                        <div class="row">
                            <div class="col-md-12">
                                <a href="teachers.php" class="btn drp-icon btn-rounded btn-primary">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h3 class="m-b-10">Add Teacher</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    ?>
                                    <article class="card mb-4">
                                        <div class="card-header">
                                            <h4 class="card-title mb-0">Create or edit Teacher</h4>
                                        </div>
                                        <input  class="form-control" hidden required type="text" id="LeaveName" name="id" value="<?php echo $row["teacher_id"]; ?>" />

                                        <div class="card-body">
                                           <div class="form-group">
                                                <label for="LeaveName">Full Name</label>
                                                <input  class="form-control" required type="text" id="LeaveName" name="name" value="<?php echo $row["name"]; ?>" />
                                                <span class="text-danger field-validation-valid" data-valmsg-for="LeaveName" data-valmsg-replace="true"></span>
                                            </div>
                                            <div class="form-group">
                                                <label for="Description">Subject</label>
                                                <input class="form-control" required type="text" data-val="true" data-val-required="The Description field is required." id="Description" name="subject" value="<?php echo $row["subject"]; ?>" />
                                                <span class="text-danger field-validation-valid" data-valmsg-for="Description" data-valmsg-replace="true"></span>
                                            </div>
                                            <div class="form-group">
                                                        <label for="Gender">Type</label>
                                                  <select class="select2 form-control" required data-val="true"  id="Gender" name="type">
                                                      <option  value="<?php echo $row["type"]; ?>"><?php echo $row["type"]; ?></option>
                                                     <option value="Science Teacher">Science Teacher</option>
                                                     <option value="Medical Teacher">Medical Teacher</option>
                                                     <option value="Commerce Teacher">Commerce Teacher</option>
                                                     <option value="Common Teacher">Common Teacher</option>
                                                       </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" required id="FromDate" name="age" value="<?php echo $row["age"]; ?>" class="datepicker form-control" data-val="true" data-val-required="The FromDate field is required.">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control" required type="email" data-val="true" data-val-required="The Emergency Call field is required." id="EmergencyCall" name="email" value="<?php echo $row["email"]; ?>" />
                                                    <span class="input-group-addon" aria-hidden="true"><span class="glyphicon glyphicon-ok text-success"></span></span>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control" required type="text" data-val="true" data-val-required="The Emergency Call field is required." id="EmergencyCall" name="phone" value="<?php echo $row["phone"]; ?>" />
                                                    <span class="input-group-addon" aria-hidden="true"><span class="glyphicon glyphicon-ok text-success"></span></span>
                                                </div>
                                                <span class="text-danger field-validation-valid" data-valmsg-for="EmergencyCall" data-valmsg-replace="true"></span>
                                            </div>
