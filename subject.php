                                ...
                                <div id="collapseOne" class=" card-body collapse show" aria-labelledby="headingOne" data-parent="#accordionMain">
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            <div class="card">
                                                <div class="card-body">
                                                    <h4 class="card-title mb-4">Types Of Subjects</h4>
                                        ...
                                        <div class="card">
                                                        ...
                                                        <?php 
                                                            ...
                                                            <h5 class="text-muted f-w-300 mb-4">Total Subjects</h5>
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ?>
                                                <tbody>
                                                            ...
                                                            <td>
                                                                <a href="deletesubject.php?id=<?php echo $row['subject_id'];?>"><i class="feather icon-trash"></i></a>
                                                            </td> 
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <blockquote class="blockquote">
                                            <p class="mb-3">
                                                Subjects module will give you tools to manage the Subjects. </p>
                                            <h5 class="card-title mb-4">Subject Module features:</h5>
                                            <ul class="list list-unstyled mb-3">
                                                <li><i class="feather icon-check-circle btn-outline-primary"></i> Add Subjects</li>
                                                <li><i class="feather icon-check-circle btn-outline-primary"></i> Delete Subjects</li>
                                               </ul>
