                                ...
                                <div id="collapseOne" class=" card-body collapse show" aria-labelledby="headingOne" data-parent="#accordionMain">
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            <div class="card">
                                                <div class="card-body">
                                                    <h4 class="card-title mb-4">Types Of Class</h4>
                                        ...
                                        <div class="card">
                                                        <div class="card-block ticket-visitor">
                                                            ...
                                                            <h3 class="mb-2">2</h3>
                                                            <h5 class="text-muted f-w-300 mb-4">Total Classes</h5>
                                    ...
                                    <div class="card-block">
                                        <div class="table-responsive">
                                            <table id="grid" class="display table nowrap table-striped table-hover" style="width:100%">
                                                ...
                                                <td>Science,Medical,Commerce</td>
                                               </tr> <tr>
                                                <td>12-th</td>
...
<script type="text/javascript">
        ...
        $(function () {
            var doughnutChart = {
                data: {
                    labels: ["11-th Class","12-th Class"],
                    datasets: [{
