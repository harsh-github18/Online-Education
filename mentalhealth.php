                                    ...
                                    <div class="card-block">
                                        <div class="table-responsive">
                                            <table id="myTable" class="display table nowrap table-striped table-hover font-weight-bold" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        <th width="20%">Health Topics</th>
                                                        <th width="15%">WHO Article</th>
                                                ...
                                                <tbody>
                                                <tr>
                                                <td>Mental Health Action Plan</td>
                                            
                                                <td><a href="https://www.who.int/mental_health/policy/education/en/">Go to Article</a></td>
                                               </tr>
                                               <tr>
                                                <td>Neurology and Public Health</td>
                                            
                                                <td><a href="https://www.who.int/mental_health/neurology/en/">Go to Article</a></td>
                                               </tr>
                                               <tr>
                                                <td>Mental Disorders</td>
                                            
                                                <td><a href="https://www.who.int/mental_health/management/en/">Go to Article</a></td>
                                               </tr>
                                               <tr>
                                                <td>Suicide Prevention</td>
                                            
                                                <td><a href="https://www.who.int/mental_health/suicide-prevention/en/">Go to Article</a></td>
                                               </tr>
                                               <tr>
                                                <td>Mental Health Emergencies</td>
                                            
                                                <td><a href="https://www.who.int/mental_health/emergencies/en/">Go to Article</a></td>
                                               </tr>
