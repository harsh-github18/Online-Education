            ...
            <div class="pcoded-inner-content">
                ...
                <div class="page-header">
                    <div class="page-block">
                        <div class="row">
                            <div class="col-md-12">
                                <a href="leave.php" class="btn drp-icon btn-rounded btn-primary">
                ...
                <div class="main-body">
                    <div class="page-wrapper">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <form method="post" action="Leaveupdate.php">
                                    ...
                                    <div class="card-footer">
                                    <a href="leave.php"><button type="submit" class="btn btn-primary">Close</button><a>
