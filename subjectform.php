            ...
            <div class="pcoded-inner-content">
                ...
                <div class="page-header">
                    <div class="page-block">
                        <div class="row">
                            <div class="col-md-12">
                                <a href="subject.php" class="btn drp-icon btn-rounded btn-primary">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h3 class="m-b-10">Add Subject</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="main-body">
                    <div class="page-wrapper">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <form method="post" action="subjectupdate.php">
                                    <article class="card mb-4">
                                        <div class="card-header">
                                            <h4 class="card-title mb-0">Create or edit Subject</h4>
                                        </div>
                                        <div class="card-body">
                                           <div class="form-group">
                                                <label for="LeaveName">Subject Name</label>
                                            ...
                                            <div class="form-group">
                                                  ...
                                                  <select class="select2 form-control" required data-val="true"  id="Gender" name="type">
                                                     ...
                                                     <option value="Medical Stream">Medical Stream</option>
                                                     <option value="Commerce Stream">Commerce Stream</option>
                                                     <option value="Common Stream">Common Stream</option>
                                                       </select>
