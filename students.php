                                ...
                                <div id="collapseOne" class=" card-body collapse show" aria-labelledby="headingOne" data-parent="#accordionMain">
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            <div class="card">
                                                <div class="card-body">
                                                    <h4 class="card-title mb-4">Types Of Students</h4>
                                        ...
                                        <div class="card">
                                                        ...
                                                        <?php 
                                                            ...
                                                            <h5 class="text-muted f-w-300 mb-4">Total Students</h5>
...
<br>
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ?>
                                                <tbody>
                                                <td>
                                                                <a href="editstudent.php?id=<?php echo $row['student_id'];?>"><i class="feather icon-edit"></i></a>
                                                            </td>
                                                            <td>
                                                                <a href="deletestudent.php?id=<?php echo $row['student_id'];?>"><i class="feather icon-trash"></i></a>
                                                            </td> 
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <p class="mb-3">
                                                Students module will give you tools to manage teacher records 
                                                .                                </p>
                                            <h5 class="card-title mb-4">Student Module features:</h5>
                                            <ul class="list list-unstyled mb-3">
                                                <li><i class="feather icon-check-circle btn-outline-primary"></i> Add Students</li>
                                                <li><i class="feather icon-check-circle btn-outline-primary"></i> Edit Students</li>
                                                <li><i class="feather icon-check-circle btn-outline-primary"></i> Delete Students</li>
                                            </ul>
                                        </blockquote>
...
<script type="text/javascript">
        ...
        $(function () {
            var doughnutChart = {
                data: {
                    labels: ["Science Students","Medical Students","Commerce Students"],
                    datasets: [{
