            ...
            <div class="pcoded-inner-content">
                ...
                <div class="page-header">
                    <div class="page-block">
                        <div class="row">
                            <div class="col-md-12">
                                <a href="notice2.php" class="btn drp-icon btn-rounded btn-primary">
                ...
                <div class="main-body">
                    <div class="page-wrapper">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <form method="post" action="noticeupdate2.php">
                                    <article class="card mb-4">
                                        ...
                                        <div class="card-body">
                                           <div class="form-group">
                                                <label for="LeaveName">Notice</label>
                                                <input  class="form-control" required type="text" id="LeaveName" name="notice" value="" />
                                                <span class="text-danger field-validation-valid" data-valmsg-for="LeaveName" data-valmsg-replace="true"></span>
                                            </div>
                                           
                                            <div class="form-group">
                                                <label for="LeaveName">Description</label>
                                                <input  class="form-control" required type="text" id="LeaveName" name="description" value="" />
                                                <span class="text-danger field-validation-valid" data-valmsg-for="LeaveName" data-valmsg-replace="true"></span>
                                            </div>
