                                ...
                                <div id="collapseOne" class=" card-body collapse show" aria-labelledby="headingOne" data-parent="#accordionMain">
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            <div class="card">
                                                <div class="card-body">
                                                    <h4 class="card-title mb-4">Types Of Teachers</h4>
                                        ...
                                        <?php 
                                                        ...
                                                        <div class="card-block ticket-visitor">
                                                            ...
                                                            <h5 class="text-muted f-w-300 mb-4">Total Teachers</h5>
...
<br>
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ?>
                                                <tbody>
                                                <td>
                                                                <a href="editteacher.php?id=<?php echo $row['teacher_id'];?>"><i class="feather icon-edit"></i></a>
                                                            </td>
                                                            <td>
                                                                <a href="deleteteacher.php?id=<?php echo $row['teacher_id'];?>"><i class="feather icon-trash"></i></a>
                                                            </td>           
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <blockquote class="blockquote">
                                            <p class="mb-3">
                                                Teacher module will give you tools to manage teacher records 
                                                .                                </p>
                                            <h5 class="card-title mb-4">Teacher Module  features:</h5>
                                            <ul class="list list-unstyled mb-3">
                                                <li><i class="feather icon-check-circle btn-outline-primary"></i> Add Teacher</li>
                                                <li><i class="feather icon-check-circle btn-outline-primary"></i> Edit Teacher</li>
                                                <li><i class="feather icon-check-circle btn-outline-primary"></i> Delete Teacher</li>
                                            </ul>
...
<script type="text/javascript">
        ...
        $(function () {
            var doughnutChart = {
                data: {
                    labels: ["Science Teachers","Medical Teachers","Commerce Teachers"],
                    datasets: [{
