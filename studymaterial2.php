                                ...
                                <div id="collapseOne" class=" card-body collapse show" aria-labelledby="headingOne" data-parent="#accordionMain">
                                    <div class="row">
                                        ...
                                        <div class="card">
                                                        ...
                                                        <?php 
                                                                    $sql = "select count(material_id) as a from studymaterial";
                                                                    $result = mysqli_query($con, $sql);
                                                                    $row = mysqli_fetch_array($result)
                                                                   ?>
                                                            <h3 class="mb-2"><?php echo $row["a"];?></h3>
                                                            <h5 class="text-muted f-w-300 mb-4">Total Study Materials</h5>
...
<br>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>List of Study Materials</h5>
                                        <div class="card-header-right">
                                            <div class="btn-group card-option">
                                                <form action="studymaterialform.php">
                                    ...
                                    <div class="card-block">
                                        <div class="table-responsive">
                                            <table id="myTable" class="font-weight-bold display table nowrap table-striped table-hover" style="width:100%">
                                                <thead>
                                                    <tr>
                                                  
                                                        <th width="20%">Subject Name</th>
                                                        <th width="15%">Open Study Material</th>
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ?>
                                                ...
                                                <td>
                                                                <a href="maincontent2.php?name=<?php echo $row['name'];?>"><button class="btn btn-primary">Study Material</button></a>
                                                            </td>                                                
