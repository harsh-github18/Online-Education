                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                                    ...
                                                                    <select class="select2 form-control" required
                                                                        data-val="true" id="Gender" name="subject">
            ...
            while ($row = mysqli_fetch_array($result)) {
                ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control" required type="email" data-val="true" data-val-required="The Emergency Call field is required." id="EmergencyCall" name="email" value="" />
                                                    <span class="input-group-addon" aria-hidden="true"><span class="glyphicon glyphicon-ok text-success"></span></span>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control" required type="password" data-val="true" data-val-required="The Emergency Call field is required." id="EmergencyCall" name="password" value="" />
                                                    <span class="input-group-addon" aria-hidden="true"><span class="glyphicon glyphicon-ok text-success"></span></span>
                                                </div>
                                                <span class="text-danger field-validation-valid" data-valmsg-for="EmergencyCall" data-valmsg-replace="true"></span>
                                            </div>
