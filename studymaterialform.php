        ...
        <div class="pcoded-content">
            <div class="pcoded-inner-content">
                ...
                <div class="page-header">
                    <div class="page-block">
                        <div class="row">
                            <div class="col-md-12">
                                <a href="studymaterial2.php" class="btn drp-icon btn-rounded btn-primary">
                ...
                <div class="main-body">
                    <div class="page-wrapper">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <form method="post" action="materialupdate.php">
                                    <article class="card mb-4">
                                        <div class="card-header">
                                            <h4 class="card-title mb-0">Create Study Material</h4>
                                        </div>
                                        <div class="card-body">
                                        <div class="form-group">
                                                        <label for="Gender">Subject Name</label>
                                                  <select class="select2 form-control" required  id="Gender" name="subjectname">
            ...
            while ($row = mysqli_fetch_array($result)) {
                ?>
                                                    ...
                                                    <div class="form-group">
                                                                    <label for="FromDate">Chapter Number</label>
                                                                    <div class="input-group">
                                                                        <input type="text"  required id="FromDate"
                                                                            name="chapternumber" value=""
                                                                            class="datepicker form-control"
                                                                            data-val="true"
                                                                            data-val-required="The FromDate field is required.">
                                                                    </div>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="FromDate">Chapter Name</label>
                                                                    <div class="input-group">
                                                                        <input type="text"  required id="FromDate"
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="FromDate">Chapter English Link</label>
                                                                    <div class="input-group">
                                                                        <input type="text"   id="FromDate"
                                                                            name="englishlink" value=""
                                                                            class="datepicker form-control"
                                                                            data-val="true"
                                                                            data-val-required="The FromDate field is required.">
                                                                    </div>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="FromDate">Chapter Hindi Link</label>
                                                                    <div class="input-group">
                                                                        <input type="text"   id="FromDate"
                                                                            name="hindilink" value=""
                                                                            class="datepicker form-control"
                                                                            data-val="true"
                                                                            data-val-required="The FromDate field is required.">
                                                                    </div>
