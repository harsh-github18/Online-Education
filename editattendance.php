...
<body>
    ...
    <div id="pcoded" class="pcoded">
        ...
        <div class="pcoded-container navbar-wrapper">
                                ...
                                <div class="pcoded-inner-content">
                                    ...
                                    <div class="page-header">
                                        <div class="page-block">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <a href="attendance.php" class="btn drp-icon btn-rounded btn-primary">
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-md-12">
                                                    <div class="page-header-title">
                                                        <h3 class="m-b-10">Edit Attendance</h3>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="main-body">
                                        <div class="page-wrapper">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <form method="post" action="attendanceupdate4.php">
                                                    <?php
            // put your code here
            $id=$_GET['id'];
                ...
                ?>
                                                        <article class="card mb-4">
                                                            <div class="card-header">
                                                                <h4 class="card-title mb-0">Edit Attendance
                                                                </h4>
                                                            </div>
            ...
            while ($row = mysqli_fetch_array($result)) {
                ?>
                                                                    <label for="Gender">On behalf</label>
                                                                    <select class="select2 form-control" required
                                                                        data-val="true" id="Gender" name="behalf">
                                                                        <option value="<?php echo $row["behalf"]; ?>"><?php echo $row["behalf"]; ?></option>
                                                                        <?php }?>
            ...
            while ($row = mysqli_fetch_array($result)) {
                ?>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input class="form-control" required type="date"
                                                                            ...
                                                                            id="EmergencyCall" name="date" value="<?php echo $row["date"]; ?>" />
                                                                        <span class="input-group-addon"
                                                                            aria-hidden="true"><span
                                                                                class="glyphicon glyphicon-ok text-success"></span></span>
                                                                    </div>
                                                                ...
                                                                <?php }?>                                                                        <option value="Present">Present</option>
